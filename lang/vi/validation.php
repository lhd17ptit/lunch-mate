...
return [
    ...
    | lớp kiểm tra dữ liệu. Một số quy tắc có nhiều phiên bản như các
    | quy tắc về kích thước. Bạn có thể tự do điều chỉnh các thông báo này.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Bạn có thể chỉ định thông báo xác thực tùy chỉnh cho các thuộc tính bằng
    | quy ước "attribute.rule" để đặt tên cho các dòng. Điều này giúp bạn
    | nhanh chóng chỉ định thông báo tùy chỉnh cho một quy tắc thuộc tính cụ thể.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau được sử dụng để thay thế cho các thuộc tính
    | giúp thông báo trở nên dễ hiểu hơn như "Địa chỉ Email" thay vì "email".
    |
    */
